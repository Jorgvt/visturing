...
print(f"Correlations (Order) [Achrom]: {calculate_correlations_with_ground_truth(b_a, d_a)}")
...
print(f"Correlations (Order) [RG]: {calculate_correlations_with_ground_truth(b_rg, d_rg)}")
...
print(f"Correlations (Order) [YB]: {calculate_correlations_with_ground_truth(b_yb, d_yb)}")
...
print(f"Correlation (Pearson): {pearson}")
