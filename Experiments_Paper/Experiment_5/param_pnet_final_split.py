...
print(f"Correlation Order (Achrom): {calculate_correlations_with_ground_truth(diffs_stack, ds)}")


import scipy.stats as stats


print(f"Pearson (Achrom): {stats.pearsonr(diffs_stack.ravel(), ds.ravel())}")
