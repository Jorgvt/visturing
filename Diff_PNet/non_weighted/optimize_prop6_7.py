...
def main():
    ...
    print("Starting JAX PerceptNet optimization experiment on Prop. 6 & 7 using NON-WEIGHTED correlation...")
    ...
    import pickle
    save_path = os.path.join(os.path.dirname(__file__), "model_pnet_prop6_7.pkl")
