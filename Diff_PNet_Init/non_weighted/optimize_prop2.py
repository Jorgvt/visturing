...
def main():
    ...
    print("Starting JAX PerceptNet (initialized from scratch) optimization experiment on Prop. 2 (Color Discrimination) using NON-WEIGHTED correlation...")
    ...
    import pickle
    save_path = os.path.join(os.path.dirname(__file__), "model_pnet_init_prop2.pkl")
