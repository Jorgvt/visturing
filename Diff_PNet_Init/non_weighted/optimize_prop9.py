...
def main():
    ...
    print("Starting JAX PerceptNet (initialized from scratch) optimization experiment on Prop. 9 using NON-WEIGHTED correlation...")
    ...
    import pickle
    save_path = os.path.join(os.path.dirname(__file__), "model_pnet_init_prop9.pkl")
